                                              ...
                                              toml::v3::node_view<toml::v3::node> config)
{
  ...
  auto i2c                    = std::move(*optional_i2c);
  ...
  const auto *const read_command_name        = "temperature read";
  const auto *const read_command_description = "Read from the temperature sensor";
  const auto *const read_command_usage       = "temperature read";
