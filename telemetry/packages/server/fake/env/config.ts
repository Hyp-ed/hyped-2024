...
export const sensorData: SensorData = Object.fromEntries(Object.entries(measurements)
    
    // Group sensors by type
    .reduce( (acc, [key, sensor]): any => {
        ...
        return acc;
    }, { seen: new Set(), entries: [] as [string, RangeMeasurement][]} ).entries

    // Add quantity and readings properties, the latter set to the sensors' initial conditions
    .map( ([name, data] : [string, RangeMeasurement]) => [name, {
            ...data,
