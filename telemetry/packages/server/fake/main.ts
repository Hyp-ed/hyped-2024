...
*/
const generateDataSeries = (runTime: number, random: boolean = false, specific: false | string[] = false) => {
    const startData: SensorData = JSON.parse(JSON.stringify(dataManager.getData()));
