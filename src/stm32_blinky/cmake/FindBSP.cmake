...
set(BSP_F0_SOURCES_STM32072B_EVAL
    eeprom
    lcd
    sd
    tsensor
)
set(BSP_F0_SOURCES_STM32091C_EVAL
    eeprom
    lcd
    sd
    tsensor
...
set(BSP_F1_SOURCES_STM3210C_EVAL
    accelerometer
    audio
    eeprom
    io
...
set(BSP_F1_SOURCES_STM3210E_EVAL
    audio
    lcd
    nand
    nor
...
# F2 ###
set(BSP_F2_BOARDS STM32F2xx_Nucleo_144 STM322xG_EVAL)
...
set(BSP_F2_SOURCES_STM322xG_EVAL
    audio
    camera
    eeprom
    io
...
set(BSP_F3_SOURCES_STM32303C_EVAL
    audio
    eeprom
    lcd
    sd
...
set(BSP_F3_SOURCES_STM32303E_EVAL
    audio
    eeprom
    lcd
    sd
...
set(BSP_F3_SOURCES_STM32373C_EVAL
    audio
    eeprom
    lcd
    sd
...
set(BSP_F4_SOURCES_STM32F413H_Discovery
    audio
    lcd
    psram
    qspi
...
set(BSP_F4_SOURCES_STM32F429I_Discovery
    eeprom
    gyroscope
    io
    lcd
...
set(BSP_F4_SOURCES_STM324x9I_EVAL
    audio
    camera
    eeprom
    io
...
set(BSP_F4_SOURCES_STM324xG_EVAL
    audio
    camera
    eeprom
    io
...
set(BSP_F4_SOURCES_STM32412G_Discovery
    audio
    eeprom
    lcd
    qspi
...
set(BSP_F4_SOURCES_STM3232446E_EVAL
    audio
    camera
    eeprom
    io
...
set(BSP_F4_SOURCES_STM32469I_EVAL
    audio
    camera
    eeprom
    io
...
set(BSP_F4_SOURCES_STM32469I_Discovery
    audio
    eeprom
    lcd
    qspi
...
set(BSP_F7_SOURCES_STM32F723E_Discovery
    audio
    lcd
    psram
    qspi
...
set(BSP_F7_SOURCES_STM32F769I_EVAL
    audio
    camera
    eeprom
    io
...
set(BSP_F7_SOURCES_STM32F769I_Discovery
    audio
    eeprom
    lcd
    qspi
...
set(BSP_F7_SOURCES_STM32F7308_Discovery
    audio
    lcd
    psram
    qspi
...
set(BSP_F7_SOURCES_STM32F7508_Discovery
    audio
    camera
    eeprom
    lcd
...
set(BSP_F7_SOURCES_STM32746G_Discovery
    audio
    camera
    eeprom
    lcd
...
set(BSP_F7_SOURCES_STM32756G_EVAL
    audio
    camera
    eeprom
    io
...
set(BSP_G0_SOURCES_STM32G081B_EVAL
    lcd
    mux
    pwr
    sd
...
# G4 ###
set(BSP_G4_BOARDS B-G474E-DPOW1 STM32G4xx_Nucleo STM32G474E-EVAL)
...
set(BSP_G4_SOURCES_STM32G481B_EVAL
    audio
    bus
    env_sensor
    idd
...
set(BSP_H7_SOURCES_STM32H7B3I_Discovery
    audio
    bus
    camera
    eeprom
...
set(BSP_H7_SOURCES_STM32H7B3I_EVAL
    audio
    bus
    camera
    eeprom
...
set(BSP_H7_SOURCES_STM32H743I_EVAL
    audio
    bus
    eeprom
    io
...
set(BSP_H7_SOURCES_STM32H745I_Discovery
    audio
    bus
    lcd
    mmc
...
set(BSP_H7_SOURCES_STM32H747I_Discovery
    audio
    bus
    camera
    lcd
...
set(BSP_H7_SOURCES_STM32H747I_EVAL
    audio
    bus
    eeprom
    io
...
set(BSP_H7_SOURCES_STM32H750B_Discovery
    audio
    bus
    lcd
    mmc
...
set(BSP_L0_SOURCES_STM32L073Z_EVAL
    eeprom
    glass_lcd
    idd
    io
...
set(BSP_L1_SOURCES_STM32L152D_EVAL
    audio
    eeprom
    audio
    glass_lcd
...
set(BSP_L4_SOURCES_B_L475E_IOT01
    accelerometer
    gyro
    hsensor
    magneto
...
set(BSP_L4_SOURCES_STM32L4P5G_Discovery
    idd
    io
    lcd
    mmc
...
set(BSP_L4_SOURCES_STM32L4R9I_EVAL
    audio
    dsi_lcd
    dsi_ts
    eeprom
...
set(BSP_L4_SOURCES_STM32L4R9I_Discovery
    audio
    camera
    idd
    io
...
set(BSP_L4_SOURCES_STM32L476G_EVAL
    audio
    eeprom
    glass_lcd
    idd
...
set(BSP_L4_SOURCES_STM32L476G_Discovery
    audio
    compass
    glass_lcd
    gyroscope
...
set(BSP_L4_SOURCES_STM32L496G_Discovery
    audio
    camera
    idd
    io
...
# L5 ###
set(BSP_L5_BOARDS STM32L552E_EVAL STM32L562E-Discovery STM32L5xx_Nucleo_144)
...
set(BSP_L5_SOURCES_STM32L562E_Discovery
    audio
    bus
    idd
    lcd
...
set(BSP_L5_SOURCES_STM32L552E_EVAL
    audio
    bus
    idd
    io
...
# MP1 ###
set(BSP_MP1_BOARDS STM32MP15xx_DISCO STM32MP15xx_EVAL)
...
set(BSP_WB_SOURCES_STM32WB5MM_Discovery
    audio
    bus
    env_sensors
    env_sensors_ex
...
# WL ###
set(BSP_WL_BOARDS STM32WLxx_Nucleo)
...
foreach(COMP ${BSP_FIND_COMPONENTS})
  ...
  if(NOT STM32_CUBE_${FAMILY}_PATH)
    ...
    message(
      STATUS
        "No STM32_CUBE_${FAMILY}_PATH specified using default: ${STM32_CUBE_${FAMILY}_PATH}"
    )
  endif()
  ...
  target_link_libraries(
    BSP::STM32::${FAMILY}${CORE_C} INTERFACE STM32::${FAMILY}${CORE_C}
  )
  target_include_directories(
    BSP::STM32::${FAMILY}${CORE_C}
    INTERFACE "${BSP_${FAMILY}_PATH}/Components/Common"
  )
  ...
  foreach(BOARD ${BSP_${FAMILY}_BOARDS})
    ...
    find_path(
      BSP_${BOARD_CANONICAL}_PATH
      NAMES ${BOARD_CANONICAL_L}.h
      PATHS "${BSP_${FAMILY}_PATH}/${BOARD}"
            "${BSP_${FAMILY}_PATH}/${BSP_${FAMILY}_DIR_${BOARD_CANONICAL}}"
      NO_DEFAULT_PATH
    )
    ...
    target_link_libraries(
      BSP::STM32::${BOARD_CANONICAL}${CORE_C}
      INTERFACE BSP::STM32::${FAMILY}${CORE_C} CMSIS::STM32::${FAMILY}${CORE_C}
    )
    target_include_directories(
      BSP::STM32::${BOARD_CANONICAL}${CORE_C}
      INTERFACE "${BSP_${BOARD_CANONICAL}_PATH}"
    )
    target_sources(
      BSP::STM32::${BOARD_CANONICAL}${CORE_C}
      INTERFACE "${BSP_${BOARD_CANONICAL}_PATH}/${BOARD_CANONICAL_L}.c"
    )

    foreach(SRC ${BSP_${FAMILY}_SOURCES_${BOARD_CANONICAL}})
      target_sources(
        BSP::STM32::${BOARD_CANONICAL}${CORE_C}
        INTERFACE "${BSP_${BOARD_CANONICAL}_PATH}/${BOARD_CANONICAL_L}_${SRC}.c"
      )
    endforeach()
    if(BSP_${FAMILY}_DEVICE_${BOARD_CANONICAL})
      target_link_libraries(
        BSP::STM32::${BOARD_CANONICAL}${CORE_C}
        INTERFACE
          CMSIS::STM32::${BSP_${FAMILY}_DEVICE_${BOARD_CANONICAL}}${CORE_C}
      )
    endif()
  endforeach()
  ...
  foreach(BCOMP ${BSP_${FAMILY}_COMPONENTS})
    ...
    target_link_libraries(
      BSP::STM32::${FAMILY}${CORE_C}::${BCOMP_U}
      INTERFACE BSP::STM32::${FAMILY}${CORE_C} CMSIS::STM32::${FAMILY}${CORE_C}
    )
    target_include_directories(
      BSP::STM32::${FAMILY}${CORE_C}::${BCOMP_U}
    ...
    find_file(
      BSP_${BOARD_CANONICAL}_${BCOMP}_SOURCE
      NAMES ${BCOMP}.c
    ...
    if(BSP_${BOARD_CANONICAL}_${BCOMP}_SOURCE)
      target_sources(
        BSP::STM32::${FAMILY}${CORE_C}::${BCOMP_U}
        INTERFACE "${BSP_${BOARD_CANONICAL}_${BCOMP}_SOURCE}"
      )
    endif()
  endforeach()
