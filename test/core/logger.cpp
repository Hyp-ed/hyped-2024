...
TEST(Logger, Stdout)
{
  ...
  testStdoutLog(core::LogLevel::kDebug, manual_time, "00:00:00.000 DEBUG[test] test\n");
  testStdoutLog(core::LogLevel::kInfo, manual_time, "00:00:00.000 INFO[test] test\n");
...
TEST(Logger, Stderr)
{
  ...
  testStderrLog(core::LogLevel::kFatal, manual_time, "00:00:00.000 FATAL[test] test\n");
}
...
TEST(Logger, VaryingTimes)
{
  ...
  testStdoutLog(core::LogLevel::kDebug, manual_time, "00:01:00.000 DEBUG[test] test\n");
  manual_time.set_time(std::chrono::system_clock::from_time_t(1));
  testStdoutLog(core::LogLevel::kDebug, manual_time, "00:00:01.000 DEBUG[test] test\n");
}
